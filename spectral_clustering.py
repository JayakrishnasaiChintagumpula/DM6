...
def spectral_clustering():
    ...
    plt.title(f'Clustering for Dataset 0 with high ARI and with k value 5')
    plt.suptitle('Spectral Clustering')
    plt.xlabel('Feature number 1')
    plt.ylabel('Feature number 2')
    plt.colorbar(label='ID of Cluster')
    plt.grid(True)
    pdf_pages.savefig() 
    plt.close()
    ...
    plt.title(f'Clustering for Dataset 2 with low SSE and with k value 5')
    plt.suptitle('Spectral Clustering')
    plt.xlabel('Feature number 1')
    plt.ylabel('Feature number 2')
    plt.colorbar(label='ID of cluster')
    ...
    plt.title('Eigenvalues Plot for all Datasets')
    plt.suptitle('Spectral Clustering')
